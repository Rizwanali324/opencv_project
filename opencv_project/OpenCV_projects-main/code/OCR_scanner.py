...
img = cv2.imread('OpenCV_projects-main/data/document.jpg')
...
# Check if a valid contour was found before drawing
if biggest.size != 0:
    cv2.drawContours(img, [biggest], -1, (0, 255, 0), 3)
else:
    print("No valid contour found.")

# Continue only if a valid contour was found
if biggest.size != 0:
    ...
    max_height = int(max_width * 1.414)  # for A4 aspect ratio
